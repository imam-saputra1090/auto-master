...
const SWF_ANIMATIONS = {
  ...
  1: [
    { file: 'AAA brake sys.swf', title: 'Sistem Rem Lengkap', slide: 0, desc: 'Animasi sistem rem kendaraan secara keseluruhan' },
    { file: 'AAA OTO brake-simple.swf', title: 'Prinsip Dasar Rem', slide: 0, desc: 'Cara kerja dasar sistem pengereman' },
    { file: 'AAA OTO brake-hydraulic1.swf', title: 'Rem Hidrolik (Bagian 1)', slide: 1, desc: 'Sistem rem hidrolik bagian pertama' },
    { file: 'AAA OTO brake-hydraulic2.swf', title: 'Rem Hidrolik (Bagian 2)', slide: 1, desc: 'Sistem rem hidrolik bagian kedua' },
    { file: 'AAA OTO brake-hydraulic3.swf', title: 'Rem Hidrolik (Bagian 3)', slide: 1, desc: 'Sistem rem hidrolik bagian ketiga' },
    { file: 'AAA OTO disc-brake.swf', title: 'Rem Cakram', slide: 2, desc: 'Animasi cara kerja rem cakram' },
    { file: 'AAA disk brake.swf', title: 'Detail Rem Cakram', slide: 2, desc: 'Detail komponen rem cakram' },
    { file: 'AAA BRAKE DISK INST.swf', title: 'Pemasangan Rem Cakram', slide: 2, desc: 'Prosedur pemasangan rem cakram' },
    { file: 'AAA DISK BRAKE TORQUE.swf', title: 'Torsi Rem Cakram', slide: 2, desc: 'Pengukuran torsi rem cakram' },
    { file: 'AAA OTO drum-brake1.swf', title: 'Rem Tromol (Bagian 1)', slide: 3, desc: 'Animasi cara kerja rem tromol' },
    { file: 'AAA OTO drum-brake3.swf', title: 'Rem Tromol (Bagian 3)', slide: 3, desc: 'Detail rem tromol' },
    { file: 'AAA drum brake.swf', title: 'Detail Rem Tromol', slide: 3, desc: 'Komponen rem tromol' },
    { file: 'AAA drum_brake.swf', title: 'Animasi Rem Tromol', slide: 3, desc: 'Animasi kerja rem tromol' },
    { file: 'drum_brake.swf', title: 'Rem Tromol', slide: 3, desc: 'Cara kerja rem tromol' },
    { file: 'AAA BRAKE DRUM ADJ.swf', title: 'Penyetelan Rem Tromol', slide: 3, desc: 'Prosedur penyetelan rem tromol' },
    { file: 'AAA BRAKE DRUM REMV.swf', title: 'Pembongkaran Rem Tromol', slide: 3, desc: 'Prosedur pembongkaran rem tromol' },
    { file: 'AAA master_silinder.swf', title: 'Master Silinder', slide: 4, desc: 'Animasi kerja master silinder rem' },
    { file: 'master_silinder.swf', title: 'Detail Master Silinder', slide: 4, desc: 'Komponen master silinder' },
    { file: 'AAA booster.swf', title: 'Brake Booster', slide: 4, desc: 'Animasi brake booster / penguat rem' },
    { file: 'AAA OTO power-brake5.swf', title: 'Power Brake', slide: 4, desc: 'Sistem power brake' },
    { file: 'AAA leading.swf', title: 'Leading & Trailing Shoe', slide: 4, desc: 'Animasi leading dan trailing shoe' },
    { file: 'AAA abs.swf', title: 'Sistem ABS', slide: 5, desc: 'Animasi cara kerja Anti-lock Braking System' },
    { file: 'AAA abs ecu.swf', title: 'ECU ABS', slide: 5, desc: 'Electronic Control Unit untuk ABS' },
    { file: 'AAA HAND BRAKE.swf', title: 'Rem Tangan / Parkir', slide: 5, desc: 'Animasi sistem rem tangan' },
    { file: 'AAA BRAKE CHECK0.swf', title: 'Pemeriksaan Rem', slide: 5, desc: 'Prosedur pemeriksaan sistem rem' },
    { file: 'AAA BRAKE01.swf', title: 'Rem Dasar', slide: 0, desc: 'Animasi rem dasar' },
    { file: 'AAA RAKE-01.swf', title: 'Komponen Rem', slide: 0, desc: 'Detail komponen sistem rem' },
    { file: 'dual_brake.swf', title: 'Rem Ganda / Dual Brake', slide: 4, desc: 'Sistem rem ganda' },
    { file: 'ADJUST BRAKE.swf', title: 'Penyetelan Rem', slide: 5, desc: 'Cara menyetel rem' },
    { file: 'BRAKE SHOE CLN.swf', title: 'Pembersihan Sepatu Rem', slide: 5, desc: 'Prosedur pembersihan sepatu rem' },
    { file: 'OPEN DISK.swf', title: 'Pembukaan Disk Rem', slide: 2, desc: 'Cara membuka komponen disk rem' },
    { file: 'AAA DISK PREE LOAD.swf', title: 'Pre-load Disk', slide: 2, desc: 'Penyetelan pre-load disk rem' },
    { file: 'melepas roda.swf', title: 'Melepas Roda', slide: 5, desc: 'Prosedur melepas roda kendaraan' }
  ],
